...
// Attempt insert query execution
    $sql = "INSERT INTO albums (album_title, album_artist, release_date, image_url, credits, artist_email)" . " VALUES ('$album_name', '$name', now(), '/album-covers/step0001.jpg' , '$credits', '$email')";
